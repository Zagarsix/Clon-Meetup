		...
		<>
			...
			<div className="text-center" style={{ backgroundColor: "grey" }}>
				<main className="main-section w-100 h-100 p-3 mb-1">
					...
					<h3>This is a mini project created by <a href="https://4geeksacademy.com" className="text-primary"> 4GeeksAcademy</a></h3>
					<h6>Using: ReactJS, Bootstrap, @Fortawesome, Moment, React-router </h6>
					{store.prueba}
				</main>

			</div>
			<div className="container d-flex justify-content-md-center align-items-center py-1" style={{background:"none"}}>
				<div className="DateEvent justify-content-between" style={{background:"pink"}}>
					<h1>April 28</h1>
				</div>
